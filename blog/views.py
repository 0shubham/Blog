...
from blog.forms import PostCreateForm, UserCreateForm , UserRegistrationForm, UserEditForm, ProfileEditForm, PostEditForm, CommentForm
...
def post_list(request):
    post_list = Post.objects.all().order_by('-id')  #objects
